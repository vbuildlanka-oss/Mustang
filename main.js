 ...
 * The stage is pinned by ScrollTrigger for the whole sequence, so it stays
 * fixed on screen while scroll progress scrubs through every frame. The scroll
 * distance is generated by ScrollTrigger's pin spacer (end: "+=" ...), so there
 * is no separate tall track that could scroll past into a black screen. */
